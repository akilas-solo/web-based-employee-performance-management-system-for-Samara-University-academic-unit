...
if ($period_id > 0) {
    ...
    $sql = "SELECT u.user_id, u.full_name, u.email, u.position, d.name as department_name,
    ...
    $sql = "SELECT d.department_id, d.name,
            ...
            FROM departments d
            LEFT JOIN users u ON u.department_id = d.department_id AND u.role = 'staff'
            LEFT JOIN evaluations e ON u.user_id = e.evaluatee_id AND e.period_id = ?
            WHERE d.college_id = ?";
    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <?php if ($period_id > 0 && !empty($staff_performance)): ?>
                <a href="<?php echo $base_url; ?>college/export_report.php?period_id=<?php echo $period_id; ?>&department_id=<?php echo $department_id; ?>&report_type=<?php echo $report_type; ?>" class="d-none d-sm-inline-block btn btn-sm btn-theme shadow-sm">
                                ...
                                <tbody>
                                    <?php foreach ($staff_performance as $staff): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo $base_url; ?>college/staff_evaluations.php?id=<?php echo $staff['user_id']; ?>&period_id=<?php echo $period_id; ?>" class="btn btn-sm btn-info">
